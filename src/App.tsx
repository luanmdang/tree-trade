...
import { Search, PlusCircle, Sun, Moon, LogIn, LogOut } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-gray-900">
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        <div className="w-96 overflow-y-auto bg-white dark:bg-gray-800 border-r border-[#e9ecef] dark:border-gray-700">
